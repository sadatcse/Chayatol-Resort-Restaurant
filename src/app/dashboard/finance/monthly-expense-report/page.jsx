        ...
        <div className="flex flex-wrap items-center justify-between gap-4 bg-white dark:bg-brand-charcoal p-5 rounded-2xl border border-brand-beige dark:border-brand-beige/20 shadow-sm mb-8">
          ...
          {canEdit && (
            <div className="flex gap-2.5">
              ...
              <button onClick={() => setPrintData({ reportData, detailedExpenses })} className="btn bg-brand-primary text-white hover:bg-brand-secondary border-none btn-sm rounded-full gap-2 px-5 h-10 font-bold uppercase tracking-wider text-[10px] cursor-pointer" disabled={isLoading}>
