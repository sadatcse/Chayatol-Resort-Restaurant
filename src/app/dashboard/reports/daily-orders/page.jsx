...
function DailyOrdersContent() {
    ...
    const {
        ...
        documentTitle: "Daily_Orders_Report"
    });
    ...
    const handleExportExcel = () => {
        ...
        exportToExcel(formatted, "Daily_Orders_Report");
    };
    ...
    const handleExportCsv = () => {
        ...
        exportToCsv(formatted, "Daily_Orders_Report");
    };
        ...
        <div className="p-4 sm:p-6 lg:p-8 bg-slate-50 dark:bg-zinc-950 min-h-screen text-gray-800 dark:text-zinc-100 font-sans transition-colors duration-200">
            ...
            <div className="hidden">
                {printData && (
                    <PrintReportTemplate
                        ref={printRef}
                        title={`Daily Order Report (${counter})`}
                        subtitle="Aggregated counter transaction and register sales records"
