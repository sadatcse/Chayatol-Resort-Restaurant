...
const BookingBlock = ({ booking, colStart, colSpan, onClick }) => {
  ...
  return (
    <motion.div
      ...
      className={`absolute top-1 bottom-1 rounded-md border shadow-sm flex items-center cursor-pointer overflow-hidden backdrop-blur-sm transition-all ${bgColor}`}
      style={{
